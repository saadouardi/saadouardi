    ...
    useEffect(()=>{
        ...
        if(!mode){
            ...
            sections.forEach(section => {
                section.style.backgroundColor = '#1b1f25';
            })
                            ...
                            <>
                                ...
                                <div className="navbar mobile-navbar">
                                    <div className="mobile-list_navbar">
                                        ...
                                        <a href='#bright-mode' onClick={handleMode}>
                                            {!BrightMode &&
